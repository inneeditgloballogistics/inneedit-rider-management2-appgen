    ...
    <div className="mesh-bg min-h-screen flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mt-6">Create Your Account</h2>
          <p className="text-slate-500 text-sm mt-2">Get started with inneedit Global Logistics</p>
        </div>
